  ...
  const generarPDF = async () => {
    try {
      ...
      reader.onloadend = () => {
        ...
        doc.setFontSize(16);
        doc.text("Concentración de Cloro", pageWidth / 2, 40, {
          align: "center",
        });
      ...
      {metodos.map((registro, index) => (
        ...
        >
          ...
          <input
            type="text"
            placeholder=""
            value={registro.tipoDeCloro}
            onChange={(e) => handleChange(index, "tipoDeCloro", e.target.value)}
            style={{
              padding: "10px",
              borderRadius: "8px",
              border: "1px solid #2980b9",
          ...
          <input
            ...
            placeholder=""
            value={registro.cantidad}
            onChange={(e) => handleChange(index, "ppm", e.target.value)}
            style={{
              padding: "10px",
              borderRadius: "8px",
              border: "1px solid #2980b9",
